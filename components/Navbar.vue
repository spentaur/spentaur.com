  ...
  >
    ...
    >
      <div class="pl-4">
        <nuxt-link
          to="/"
          class="navbar-brand text-white bg-orange-500 border-2 border-orange-500
          no-underline font-bold font-serif px-1 py-1; block md:text-xl
          hover:no-underline hover:text-orange-500 hover:bg-transparent"
        >
          spentaur.
        </nuxt-link>
      </div>
